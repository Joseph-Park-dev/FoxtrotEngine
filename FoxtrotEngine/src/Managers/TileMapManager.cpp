...
//#include "ResourceSystem/SpriteSheets/FTSpriteSheet.h"
...
//	FTDS::String fullPath = FTDS::String(path) + spriteSheet->FileName() + FileTypes::JSON_SHEET;
//
...
//
//		FTDS::HashMap<FTJSONSheet*>* mapSpriteSheets = ResourceManager::GetInstance()->GetJSONSheets();
