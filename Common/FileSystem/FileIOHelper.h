...
namespace Common
{
	...
	public:
		...
		static void ParseVector3(FTDS::String& line, Math::FTVector3& arg);
		static void ParseVector2(FTDS::String& line, Math::FTVector2& arg);
		static void ParseVector4(FTDS::String& line, Math::FTVector4& arg);
	...
	public:
		...
		static void SaveVector2(std::ofstream& ofs, const FTDS::String& valName, const Math::FTVector2& vec2);
		static void SaveVector3(std::ofstream& ofs, const FTDS::String& valName, const Math::FTVector3& vec3);
		static void SaveVector4(std::ofstream& ofs, const FTDS::String& valName, const Math::FTVector4& vec4);
