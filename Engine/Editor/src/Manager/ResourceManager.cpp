...
//	}
//
//	// void ResourceManager::LoadCoreResByType(const char* filePath, Common::FTDS::DynamicArray<Common::FTDS::String*>& aborted)
//	//{
//	//	Common::FTDS::String path(filePath);
...
//	//	}
//	//	else
//	//		aborted.PushBack(DBG_NEW Common::FTDS::String(path));
//	//}
//
...
//	//		{
//	//			Common::FTDS::String  fileName = ExtractFileName(path.C_Str());
...
//	//{
//	//	std::pair<size_t, Common::FTDS::String> resPack	  = FileIOHelper::BeginDataPackLoad(ifs, Core::ChunkKey::RESOURCE_DATA);
...
//
//	//	std::pair<size_t, Common::FTDS::String>
...
//	}
//
//	size_t ResourceManager::GetCoreTypeIdx(Common::FTDS::String& fileName)
//	{
//		size_t length = 0;
//		if (fileName.RFind(".") < 0)
...
//	}
//
//	size_t ResourceManager::GetD3D11TypeIdx(Common::FTDS::String& fileName)
//	{
//		size_t length = 0;
//		if (fileName.RFind(".") < 0)
//			return Core::ResType::UNSUPPORTED;
