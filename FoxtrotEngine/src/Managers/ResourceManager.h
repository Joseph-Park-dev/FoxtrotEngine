...
public:
	...
	MeshData&			   GetLoaded2DPrimitive(const UINT key);
	MeshData&			   GetLoaded3DPrimitive(const UINT key);
...
private:
	...
	std::unordered_map<UINT, MeshData>				mMap2DPrimitives;
	std::unordered_map<UINT, MeshData>				mMap3DPrimitives;
