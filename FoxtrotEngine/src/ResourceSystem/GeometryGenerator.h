...
public:
	...
	static void		  MakeSpriteAnimation(std::vector<FTMeshData>& animMeshes, Tile* tileMap, size_t startIdx, size_t endIdx);
	static void		  MakeSpriteAnimation(std::vector<FTMeshData>& animMeshes, Tile* tileMap, size_t count);
	...
	static std::vector<FTMeshData> ReadFromFile(FTDS::String& resPath);
